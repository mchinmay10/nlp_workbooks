...
def generate_ngram_model(input_file_path, mis_no):
    """
    Reads a dataset and generates n-gram models (bigram, trigram, four-gram, five-gram).
    """
    try:
    ...
    all_tokens = [word.lower() for sentence in sentences for word in nltk.word_tokenize(sentence)]
